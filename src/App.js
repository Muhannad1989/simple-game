  ...
  return (
    <div className="App">
      <div>
        <div className="game">
          <img
            src="https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcSBZAieOkulioNBvVilYHTpY5wiLdDKDFeXHj8aKSJYgKOj9_mS" alt="lets-play"
          />
        </div>
        <div className="container">
          ...
          <div className="row border">
            {ways.map((_, index) => <Xo key={index} index={index + 1} myId={"div" + (index + 1)} myFunction={myFunction} />)}
          </div>
        </div>
      </div>
    </div>
